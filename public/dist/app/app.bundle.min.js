...
var uuid = __webpack_require__(150);
...
var App = createClass({
	...
	loadTodos: function loadTodos() {
		...
		axios.post('/todo-list', { client: 'user-data' }).then(function (response) {
			_this.setState({
				todos: response.data
			});
		});
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(TodoList, { todos: todos, update: function update() {
...
module.exports = {
	addTodo: function addTodo(todo) {
		axios.post('/todos', todo).then(function (response) {
			return 'success';
		});
	}
};
...
var TodoList = createClass({
	...
	componentWillReiceveProps: function componentWillReiceveProps() {
		this.props.update();
	},
	render: function render() {
		var _this = this;
		...
		var renderTodos = function renderTodos() {
			...
			return todos.map(function (todo) {
				return React.createElement(Todo, _extends({ key: todo.id }, todo, { onDelete: function onDelete() {
						axios.post('/delete', { id: todo.id }).then(function (response) {
							_this.loadTodos();
						});
					} }));
			});
...
var Todo = createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: 'todo wd bck column-12' },
			React.createElement(
				'span',
				{ className: 'todo-text' },
				this.props.text
